...
class EvalOverallMetrics(BaseModel):
    ...
    #: ``None`` for classification evals (mAP is not applicable). For classification,
    #: precision/recall/f1 are MACRO-averaged and :attr:`accuracy` is the headline.
    map: float | None = 0.0
    #: Top-1 accuracy - classification evals only (``None`` for detection).
