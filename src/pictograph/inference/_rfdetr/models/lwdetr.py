...
if TYPE_CHECKING:
    from pictograph.inference._rfdetr.config import ModelConfig, TrainConfig

from pictograph.inference._rfdetr.models._defaults import MODEL_DEFAULTS, ModelDefaults
from pictograph.inference._rfdetr.models._types import BuilderArgs
from pictograph.inference._rfdetr.models.backbone import build_backbone

from pictograph.inference._rfdetr.models.heads.segmentation import SegmentationHead
from pictograph.inference._rfdetr.models.math import MLP
from pictograph.inference._rfdetr.models.postprocess import PostProcess
from pictograph.inference._rfdetr.models.transformer import build_transformer
from pictograph.inference._rfdetr.utilities.logger import get_logger
from pictograph.inference._rfdetr.utilities.tensors import NestedTensor, nested_tensor_from_tensor_list
...
# PICTOGRAPH: `build_criterion_and_postprocessors` / `build_criterion_from_config`
# are removed with their `criterion` + `matcher` imports - they build the TRAINING
# loss, which a checkpoint reload never touches. This is the only functional
# subtraction from upstream's build path; `build_model` is unchanged.
...
def build_model_from_config(
    ...
    if train_config is None:
        from pictograph.inference._rfdetr.config import TrainConfig
