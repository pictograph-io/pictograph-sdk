...
# PICTOGRAPH: the `transformers` base classes and helpers this module used are
# reimplemented in `_compat.py` - see that module for why, and for exactly which
# behaviours are preserved. The names and semantics are unchanged, so everything
# below this line is the upstream implementation.
from pictograph.inference._rfdetr._compat import (
    ACT2FN,
    BackboneConfigMixin,
    BackboneMixin,
    BackboneOutput,
...
class WindowedDinov2WithRegistersConfig(BackboneConfigMixin, PretrainedConfig):
    ...
    >>> from pictograph.inference._rfdetr.models.backbone.dinov2_with_windowed_attn import WindowedDinov2WithRegistersConfig
...
class WindowedDinov2WithRegistersModel(WindowedDinov2WithRegistersPreTrainedModel):
    ...
    def set_attn_implementation(self, attn_implementation: str) -> None:
        ...
        Example::
            ...
            >>> from pictograph.inference._rfdetr.models.backbone.dinov2_with_windowed_attn import (
