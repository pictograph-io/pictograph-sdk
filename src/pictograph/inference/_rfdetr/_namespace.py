...
# PICTOGRAPH: `build_namespace`, a deprecated no-internal-caller shim that
# existed only to wrap `_namespace_from_configs`, is dropped along with its
# `pyDeprecate` dependency.
