...
def _seg_row() -> dict:
    return {
        ...
        "failed_images": 0,
        "overall_metrics": {
            "tp": 4100, "fp": 100, "fn": 900,
            "precision": 0.976, "recall": 0.82, "f1": 0.891, "macro_f1": 0.85,
            "map": None, "accuracy": None,
            "miou": 0.803, "mean_dice": 0.85, "pixel_accuracy": 0.9,
            "mean_pixel_accuracy": 0.82, "frequency_weighted_iou": 0.803,
        },
        "per_class_metrics": [
            {"class_name": "road", "tp": 4100, "fp": 100, "fn": 900, "support": 5000,
             "precision": 0.976, "recall": 0.82, "f1": 0.891, "iou": 0.803, "dice": 0.891},
        ],
        "confusion_matrix": {"iou_threshold": None, "labels": ["road", "__background__"], "grid": [[4100, 900], [100, 4900]]},
        "seg_metrics": {
            "confidence_threshold": 0.5, "n_images": 3, "n_pixels": 30000,
            "miou": 0.803, "mean_dice": 0.85, "pixel_accuracy": 0.9,
            "mean_pixel_accuracy": 0.82, "frequency_weighted_iou": 0.803,
            "per_class": [{"class_name": "road", "iou": 0.803, "dice": 0.891, "support": 5000}],
            "operating_sweep": {
                "thresholds": [0.0, 0.5, 1.0], "miou": [0.803, 0.803, 0.0],
                "mean_dice": [0.891, 0.891, 0.0], "pixel_accuracy": [0.9, 0.9, 0.5],
                "best_miou": 0.803, "best_miou_threshold": 0.0,
            },
        },
        "worst_images": [
            {"image_id": "img-1", "filename": "a.jpg", "tp": 100, "fp": 20, "fn": 30,
             "gt_count": 1, "pred_count": 1, "miou": 0.4, "predictions": [], "ground_truth": []},
        ],
    }
...
def test_detection_row_leaves_semseg_fields_none() -> None:
    row = _seg_row()
    row["overall_metrics"] = {
        "tp": 10, "fp": 2, "fn": 1, "precision": 0.83, "recall": 0.9,
        "f1": 0.86, "macro_f1": 0.86, "map": 0.75,
    }
