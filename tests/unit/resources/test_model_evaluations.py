            ...
            best_images=[
                {
                    ...
                    "pred_count": 5,
                    "predictions": [
                        {"name": "cat", "type": "bbox", "bounding_box": {"x": 1, "y": 2, "w": 3, "h": 4}, "confidence": 0.97},
                    ],
                    "ground_truth": [
                        {"name": "cat", "type": "bbox", "bounding_box": {"x": 1, "y": 2, "w": 3, "h": 4}},
                    ],
                },
            ],
        )
...
def test_get_parses_full_metrics(httpx_mock: HTTPXMock, evals: ModelEvaluations) -> None:
    ...
    assert ev.best_images[0].predictions is not None and ev.best_images[0].predictions[0]["name"] == "cat"
